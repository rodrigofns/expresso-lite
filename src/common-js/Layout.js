...
return function(options) {
    ...
    THIS.load = function() {
        ...
        App.LoadTemplate('../common-js/Layout.html').done(function() {
            ...
            THIS.showContextMenu(false); // initially hidden
    ...
    THIS.setLeftMenuVisibleOnPhone = function(isShow) {
        ...
        } else if (isShow) { // show left menu on phones, does nothing on desktops
    ...
    THIS.showContextMenu = function(isShow) {
        $('#Layout_context').css('display', isShow ? '' : 'none');
        return THIS;
    };
